...
/*
	The unzip buffer have been set to 64k in unzip.c
	
	#define UNZ_BUFSIZE ( 131072 )			
*/
#include "../zlib/unzip.h"

extern char *SIO2_RESOURCE_PATH[ SIO2_ARCHIVE_TYPE ];
...
typedef enum
{
	...
	SIO2_RENDER_ALPHA_OBJECT	= ( 1 << 1  ),
	SIO2_RENDER_NO_MATERIAL		= ( 1 << 2  ),
	SIO2_RENDER_NO_MATRIX		= ( 1 << 3  ),	
	SIO2_RENDER_CLIPPED_OBJECT	= ( 1 << 4  ),
	SIO2_RENDER_LAMP			= ( 1 << 5  ),
	SIO2_RENDER_EMITTER			= ( 1 << 6  ),
	SIO2_RENDER_IPO				= ( 1 << 7  ),
	SIO2_EVALUATE_SENSOR		= ( 1 << 8  ),
	SIO2_EVALUATE_TIMER			= ( 1 << 9  ),
	SIO2_UPDATE_SOUND_STREAM	= ( 1 << 10 )
...
unsigned char sio2ResourceOpen( SIO2resource  *, char *, unsigned char );

void sio2ResourceClose( SIO2resource * );

void sio2ResourceCreateDictionary( SIO2resource * );

void sio2ResourceAddEntry( SIO2resource *, char *, SIO2parsercallback *, SIO2parsercallback * );

unsigned char sio2ResourceExtractFile( SIO2resource *, SIO2stream *, char *, char * );
