...
void sio2ObjectRenderFrame( SIO2object *, SIO2window * );
...
SIO2object *sio2ObjectDuplicate( SIO2object *, SIO2transform *, char *, unsigned char );
...
unsigned char sio2ObjectSetAction( SIO2object *, char *, float, float );

unsigned char sio2ObjectSetNextAction( SIO2object *, char *, float, float );
...
void sio2ObjectBuildAction( SIO2object *, unsigned int, unsigned int, char * );

void sio2ObjectClearAllAction( SIO2object * );

void sio2ObjectUpdateTimeRatio( SIO2object * );

void sio2ObjectSetVertexColorAlpha( SIO2object *, unsigned char );
