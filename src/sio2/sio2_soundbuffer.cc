...
SIO2soundbuffer *sio2SoundBufferFree( SIO2soundbuffer *_SIO2soundbuffer )
{
	...
	else
	{
		...
		alDeleteBuffers( SIO2_SOUNDBUFFER_DOUBLE_BUFFER, &_SIO2soundbuffer->bid[ 0 ] );
								  ...
								  unsigned char	   _streamed )
{
	...
	_SIO2soundbuffer->size = ( ov_pcm_total( &_SIO2soundbuffer->_OggVorbis_File, -1 ) * _vorbis_info->channels << 1 );
	...
	{
		alGenBuffers( SIO2_SOUNDBUFFER_DOUBLE_BUFFER, _SIO2soundbuffer->bid );
		
		sio2SoundBufferStream( _SIO2soundbuffer, _SIO2soundbuffer->bid[ 0 ] );
		
		sio2SoundBufferStream( _SIO2soundbuffer, _SIO2soundbuffer->bid[ 1 ] );
	}
