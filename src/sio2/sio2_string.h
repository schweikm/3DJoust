...
inline unsigned int sio2StringLen( const char *_str )
{
	unsigned int i = 0;
...
inline int sio2StringCmp( char *_str1, char *_str2 )
{
...
inline void sio2StringCpy( char *_str1, const char *_str2 )
{ memcpy( _str1, _str2, sio2StringLen( _str2 ) + 1 ); }


inline char *sio2StringChr( char *_str1, char _str2 )
{
	while( *_str1 )
	{
		++_str1;
...
inline char *sio2StringTok( char *_str1, char *_str2 )
{
	unsigned int s = sio2StringLen( _str2 );
...
inline void sio2StringToUpper( char *_str )
{
	unsigned int i = 0,
