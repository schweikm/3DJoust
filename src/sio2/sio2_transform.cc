...
void sio2TransformSetMat( SIO2transform *_SIO2transform,
						  float		    *_mat )
							...
							float		  _radz )
{
	...
	v.x = ( _SIO2transform->loc->x + cosf( _radz ) *
			_SIO2transform->dir->x - sinf( _radz ) *
			_SIO2transform->dir->y );
							
	v.y = ( _SIO2transform->loc->y + sinf( _radz ) *
			_SIO2transform->dir->x + cosf( _radz ) *
			_SIO2transform->dir->y );
