...
#define SIO2_SOUND_BUFFER_SIZE		16384
#define SIO2_VIDEO_BUFFER_SIZE		32768
...
/*
	The following modifications have been made in btDefaultCollisionConfiguration.h
	
	m_defaultMaxPersistentManifoldPoolSize(128), // 4096
	m_defaultMaxCollisionAlgorithmPoolSize(128), // 4096
*/
...
long sio2OggTell( void * );

int sio2OggClose( void * );

void sio2PngRead( png_structp, png_bytep, png_size_t );
