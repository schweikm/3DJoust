...
void sio2CameraMove( SIO2camera	*, SIO2window *, char );

void sio2CameraStrafe( SIO2camera *, SIO2window *, char );

void sio2CameraElevate( SIO2camera *, SIO2window *, char );	
...
void sio2CameraSetPerspective( SIO2camera *, SIO2window * );
