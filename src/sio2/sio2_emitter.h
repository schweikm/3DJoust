...
void sio2EmitterCreate( SIO2emitter *, SIO2material *, SIO2particlecreation *, SIO2particlerender *, vec3 *, vec3 *, vec3 *, unsigned int, float );

void sio2EmitterSetupParticles( SIO2emitter * );

void sio2EmitterResetParticles( SIO2emitter * );

void sio2EmitterRender( SIO2emitter *, SIO2window * );
