...
void sio2SetColorIndex( unsigned int, col4 * );
...
inline void sio2EnableState( unsigned int *_var, unsigned int  _state )
{  *_var = *_var | _state; }

inline void sio2DisableState( unsigned int *_var, unsigned int  _state )
{ *_var = *_var & ~_state; }

inline unsigned char sio2IsEnabled( unsigned int _var, unsigned int _state )
